/**
 * @cmanohar/flow-server — collector seed.
 *
 * Today: a Vite dev plugin (local file sink) + a dependency-free standalone
 * ingest service (`collector.mjs`, run via `flow-collector`).
 *
 ...
 */
export { flowVitePlugin } from './vite-plugin.js';
export type { FlowVitePluginOptions } from './vite-plugin.js';
